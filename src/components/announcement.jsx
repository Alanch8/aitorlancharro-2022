...
export const Announcement = () => {
  ...
  return (
    <div className={isAnnouncementShown ? "hideAnnouncement" : ""}>
      <div class="fixed inset-x-0 bottom-0 p-4 z-10">
        <div class="relative flex items-center justify-between gap-4 rounded-lg bg-gradient-to-b from-yellow-100 via-yellow-300 to-yellow-500 opacity-95 px-4 py-3 text-slate-700 shadow-lg">
          <p class="text-sm font-medium">
            Some functionalities are still in the development phase.{" "}
            <span class="text-sm font-bold underline">Stay tuned!</span>
          </p>
          <br></br>
          <button
            aria-label="Close"
